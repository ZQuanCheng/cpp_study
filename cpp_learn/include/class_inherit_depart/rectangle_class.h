#ifndef RECTANGLE_CLASS_H    // 防止头文件的重复包含和编译
...
class Rectangle: public Shape, public PaintCost
{
   public:
      ...
      Rectangle(int a, int b, int c, int d, int e, int ptr_value = 0, unsigned int n = 0);
      // _Rectangle拷贝构造函数
   ...
   private:
      // 子对象
      AB ab;   // _Rectangle 类中包含 _AB 类的对象 ab 作为自由数据成员,即子对象
      // 简单变量
      int rec;
